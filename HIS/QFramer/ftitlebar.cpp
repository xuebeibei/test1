...
void FTitleBar::initData()
{
  ...
  //  fixButton->setFocusPolicy(Qt::NoFocus);
    ...
    fixflag = true;
    maxIcon =  new QIcon(QString(":/skin/icons/light/appbar.fullscreen.box.png"));
    normalIcon =  new QIcon(QString(":/skin/icons/light/appbar.app.png"));
}
...
void FTitleBar::initUI()
{
    ...
    setLogoButton(":/skin/images/his.ico");
	QString str =str.fromLocal8Bit("");
    setTitleLabel(str, "FTitleLabel");
    setSettingButton(":/skin/icons/light/appbar.control.down.png");
    setSkinButton(":/skin/icons/light/appbar.clothes.shirt.png");
 //   setFixButton(":/skin/icons/dark/appbar.lock.png");
    setMinButton(":/skin/icons/light/appbar.minus.png");
    setMaxButton(":/skin/icons/light/appbar.app.png");
    setCloseButton(":/skin/icons/light/appbar.close.png", "close");
...
void FTitleBar::changeFix()
{
    if(fixflag)
    {
        fixButton->setIcon(QIcon(":/skin/icons/light/appbar.lock.png"));
    }
    else{
        fixButton->setIcon(QIcon(":/skin/icons/light/appbar.unlock.keyhole.png"));
    }
    fixflag = ! fixflag;
}
